          ...
          <defs>
            ...
            >
              ...
              <path
                ...
                opacity="0.35"
              />
              <circle cx="45" cy="45" r="2" fill="#fbbf24" opacity="0.28" />
            </pattern>
            ...
            >
              ...
              <polygon
                ...
                opacity="0.18"
              />
              <circle cx="90" cy="90" r="6" fill="#ec4899" opacity="0.15" />
            </pattern>
          </defs>

          {/* layered fill: base woven + larger motif */}
          <rect width="100%" height="100%" fill="url(#woven-textile)" />
          <rect width="100%" height="100%" fill="url(#geom-motif)" opacity="0.85" />
        </svg>
